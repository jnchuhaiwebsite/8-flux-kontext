<template>
  ...
  >
    <div class="max-w-7xl mx-auto px-4">
      ...
      <h2
        class="text-black text-center text-4xl font-bold mb-4 font-medium"
      >
      ...
      <div v-if="isPlansLoading" class="flex justify-center items-center py-20">
        <div
          class="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-medium"
      ...
      >
        ...
        <article
          ...
          :class="[
            ...
            plan.is_popular
              ? 'border-2 border-blue-medium shadow-lg relative'
        ...
        >
          <div
            ...
            class="absolute -top-3 right-6 px-3 py-1 bg-blue-medium text-white text-sm rounded-full"
          >
            Most Popular
          </div>
          <h3 class="text-2xl font-bold text-gray-800 mb-2 font-medium">
            {{ plan.name }}
          </h3>
          ...
          <ul class="space-y-3 mb-8" :aria-label="`${plan.name} plan features`">
            ...
            >
              <span class="mr-2 text-blue-medium" aria-hidden="true">✓</span>
              {{ feature }}
            </li>
          </ul>
          <div class="mt-auto">
  ...
  setup() {
    ...
    const getButtonClass = (plan: any): string => {
      if (plan.price === 0) {
        ...
        return "bg-blue-medium text-white hover:bg-blue-dark";
      } else {
        return "bg-blue-accent text-white hover:bg-blue-dark";
      }
    };
